...
class Postgres(object):
    ...
    def __init__(self, pg_inf=ConnectInf.demo_pg_inf):
        """
        :param pg_inf: 传入链接信息
        """
        self.pg_inf = pg_inf
    ...
    @classmethod
    def get_instance(cls, pg_inf=ConnectInf.demo_pg_inf):
        if cls.instance:
            return cls.instance
        else:
    ...
    def db_conn(self):
        ...
        try:
            ...
            print("ip:%s---Postgres connect failed:%s" % (self.ip ,e))
...
class Oracle(object):
    ...
    def __init__(self, user_inf=ConnectInf.demo_OracleUser):
    ...
    @classmethod
    def get_instance(cls, user_inf=ConnectInf.demo_OracleUser):
        if cls.instance:
            return cls.instance
        else:
    ...
    def db_conn(self):
        ...
        try:
            ...
            print("Oracle connect failed:%s" % e )
            return self.conn, self.cr
        else:

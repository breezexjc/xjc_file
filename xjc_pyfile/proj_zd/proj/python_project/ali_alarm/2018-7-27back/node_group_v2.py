...
def call_postgres(conn, date_interval, time_interval):
    ...
    sql1 = "select * from " + CONTENT.alarm_match_data + " where  rdsectid != 'UTRSS001116' and date_day ='{0}' " \
           ...
           "((length<=400  and (up_to_down_match_num>= 2 OR down_to_up_match_num>= 2)) or(length<800 and " \
           "length>400 and ((up_to_down_match_num)>=(round(length/100,2)-2)" \
           " OR down_to_up_match_num>=(round(length/100,2)-2)))) order by rdsectid"\
...
if __name__ == '__main__':
    # node_suggest()
    main('2018-07-02', '2018-07-02', '07:50:00', '08:00:00')
